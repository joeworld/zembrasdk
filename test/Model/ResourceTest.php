 ...
 *
 * @category    Class
 * @description Depending on the selected network, this field defines the target source from the platform. Each network has its own set of acceptable contents.
 * @package     Zembra\Client
 * @author      Zembra Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
