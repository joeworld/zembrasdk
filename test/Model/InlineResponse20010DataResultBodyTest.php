<?php
/**
 * InlineResponse20010DataResultBodyTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse20010DataResultBodyTest Class Doc Comment
 *
 * @category    Class
 * @description The same payload returned by the API like if the request were submitted separately to its corresponding endpoint.
 * @package     Zembra\Client
 * @author      Zembra Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20010DataResultBodyTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "InlineResponse20010DataResultBody"
     */
    public function testInlineResponse20010DataResultBody()
    {
    }
