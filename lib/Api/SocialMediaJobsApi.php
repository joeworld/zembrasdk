...
/**
 * SocialMediaJobsApi Class Doc Comment
 *
 * @category Class
 * @package  Zembra\Client
 * @author   Zembra Codegen team
...
class SocialMediaJobsApi
{
    ...
    /**
     * Operation socialJobNetworkResourceSlugContentPost
     *
     ...
     * @return \Zembra\Client\Model\InlineResponse2013
     */
    public function socialJobNetworkResourceSlugContentPost($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
    {
        list($response) = $this->socialJobNetworkResourceSlugContentPostWithHttpInfo($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content);
        return $response;
    }

    /**
     * Operation socialJobNetworkResourceSlugContentPostWithHttpInfo
     *
     * Create a social media job
     *
     ...
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Zembra\Client\Model\InlineResponse2013, HTTP status code, HTTP response headers (array of strings)
     */
    public function socialJobNetworkResourceSlugContentPostWithHttpInfo($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse2013';
        $request = $this->socialJobNetworkResourceSlugContentPostRequest($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse2013',
    ...
    /**
     * Operation socialJobNetworkResourceSlugContentPostAsync
     *
     * Create a social media job
     *
     * @param  string $internal_id (required)
     ...
     */
    public function socialJobNetworkResourceSlugContentPostAsync($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
    {
        return $this->socialJobNetworkResourceSlugContentPostAsyncWithHttpInfo($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation socialJobNetworkResourceSlugContentPostAsyncWithHttpInfo
     *
     * Create a social media job
     *
     * @param  string $internal_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialJobNetworkResourceSlugContentPostAsyncWithHttpInfo($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse2013';
        $request = $this->socialJobNetworkResourceSlugContentPostRequest($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content);
    ...
    /**
     * Create request for operation 'socialJobNetworkResourceSlugContentPost'
     *
     * @param  string $internal_id (required)
     * @param  int $stream_size_limit (required)
     * @param  int $stream_date_limit (required)
     ...
     */
    protected function socialJobNetworkResourceSlugContentPostRequest($internal_id, $stream_size_limit, $stream_date_limit, $network, $resource, $slug, $content)
    {
        // verify the required parameter 'internal_id' is set
        if ($internal_id === null || (is_array($internal_id) && count($internal_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $internal_id when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        ...
        if ($stream_size_limit === null || (is_array($stream_size_limit) && count($stream_size_limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $stream_size_limit when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        ...
        if ($stream_date_limit === null || (is_array($stream_date_limit) && count($stream_date_limit) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $stream_date_limit when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        // verify the required parameter 'resource' is set
        if ($resource === null || (is_array($resource) && count($resource) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resource when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        // verify the required parameter 'slug' is set
        if ($slug === null || (is_array($slug) && count($slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $slug when calling socialJobNetworkResourceSlugContentPost'
            );
        }
        // verify the required parameter 'content' is set
        if ($content === null || (is_array($content) && count($content) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content when calling socialJobNetworkResourceSlugContentPost'
            );
        }

        $resourcePath = '/social/job/{network}/{resource}/{slug}/{content}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Zembra\Client\Model\InlineResponse20013
     */
    public function socialJobUidGet($uid, $limit = '1000', $offset = null)
    {
        list($response) = $this->socialJobUidGetWithHttpInfo($uid, $limit, $offset);
        return $response;
    }

    /**
     * Operation socialJobUidGetWithHttpInfo
     *
     * Get stream data of requested resource from existing job by UID
     *
     * @param  string $uid The UID of the job that was returned at the time of creating the job (required)
     ...
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Zembra\Client\Model\InlineResponse20013, HTTP status code, HTTP response headers (array of strings)
     */
    public function socialJobUidGetWithHttpInfo($uid, $limit = '1000', $offset = null)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20013';
        $request = $this->socialJobUidGetRequest($uid, $limit, $offset);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse20013',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation socialJobUidGetAsync
     *
     * Get stream data of requested resource from existing job by UID
     *
     * @param  string $uid The UID of the job that was returned at the time of creating the job (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialJobUidGetAsync($uid, $limit = '1000', $offset = null)
    {
        return $this->socialJobUidGetAsyncWithHttpInfo($uid, $limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation socialJobUidGetAsyncWithHttpInfo
     *
     * Get stream data of requested resource from existing job by UID
     *
     * @param  string $uid The UID of the job that was returned at the time of creating the job (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialJobUidGetAsyncWithHttpInfo($uid, $limit = '1000', $offset = null)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20013';
        $request = $this->socialJobUidGetRequest($uid, $limit, $offset);
    ...
    /**
     * Create request for operation 'socialJobUidGet'
     *
     * @param  string $uid The UID of the job that was returned at the time of creating the job (required)
     * @param  int $limit Indicates the maximum number of elements to be returned. The default limit will be applied if omitted. (optional, default to 1000)
     * @param  int $offset Helps with pagination. It indicates the offset to be applied to the set of elements. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function socialJobUidGetRequest($uid, $limit = '1000', $offset = null)
    {
        // verify the required parameter 'uid' is set
        if ($uid === null || (is_array($uid) && count($uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $uid when calling socialJobUidGet'
            );
        }

        $resourcePath = '/social/job/{uid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $internal_id Filter results to only jobs with similar internal ID. This is the ID you set on the job that identifies it with your application. Please see the description for &#x60;internalId&#x60; on **[GET] /social/{network}/{resource}/{slug}**. (optional)
     * @param  \Zembra\Client\Model\SocialSlug $slug Filter results to only jobs with similar slug. Please see the description for &#x60;slug&#x60; on **[GET] /social/{network}/{resource}/{slug}**. (optional)
     * @param  \Zembra\Client\Model\SocialNetwork $network Returns jobs only from the requested network. (optional)
     * @param  \Zembra\Client\Model\Resource $resource Limits jobs to only those that match the selected resource type. (optional)
     * @param  \Zembra\Client\Model\Content $content Limits jobs to only those that match the selected content type. (optional)
     *
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Zembra\Client\Model\InlineResponse20014
     */
    public function socialJobsGet($limit = '100', $offset = null, $sort_by = 'timestamp', $sort_direction = 'DESC', $internal_id = null, $slug = null, $network = null, $resource = null, $content = null)
    {
        list($response) = $this->socialJobsGetWithHttpInfo($limit, $offset, $sort_by, $sort_direction, $internal_id, $slug, $network, $resource, $content);
        return $response;
    }

    /**
     * Operation socialJobsGetWithHttpInfo
     *
     * Get the list of social media jobs
     *
     * @param  int $limit Maximum number of jobs to be returned. At most 100 jobs will be returned even if this parameter is set to a higher value. (optional, default to 100)
     ...
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Zembra\Client\Model\InlineResponse20014, HTTP status code, HTTP response headers (array of strings)
     */
    public function socialJobsGetWithHttpInfo($limit = '100', $offset = null, $sort_by = 'timestamp', $sort_direction = 'DESC', $internal_id = null, $slug = null, $network = null, $resource = null, $content = null)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20014';
        $request = $this->socialJobsGetRequest($limit, $offset, $sort_by, $sort_direction, $internal_id, $slug, $network, $resource, $content);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse20014',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse4006',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialJobsGetAsync($limit = '100', $offset = null, $sort_by = 'timestamp', $sort_direction = 'DESC', $internal_id = null, $slug = null, $network = null, $resource = null, $content = null)
    {
        return $this->socialJobsGetAsyncWithHttpInfo($limit, $offset, $sort_by, $sort_direction, $internal_id, $slug, $network, $resource, $content)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation socialJobsGetAsyncWithHttpInfo
     *
     * Get the list of social media jobs
     *
     * @param  int $limit Maximum number of jobs to be returned. At most 100 jobs will be returned even if this parameter is set to a higher value. (optional, default to 100)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialJobsGetAsyncWithHttpInfo($limit = '100', $offset = null, $sort_by = 'timestamp', $sort_direction = 'DESC', $internal_id = null, $slug = null, $network = null, $resource = null, $content = null)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20014';
        $request = $this->socialJobsGetRequest($limit, $offset, $sort_by, $sort_direction, $internal_id, $slug, $network, $resource, $content);
    ...
    /**
     * Create request for operation 'socialJobsGet'
     *
     * @param  int $limit Maximum number of jobs to be returned. At most 100 jobs will be returned even if this parameter is set to a higher value. (optional, default to 100)
     * @param  int $offset Helps with pagination. It controls the offset to be applied to the set of jobs. (optional)
     * @param  string $sort_by Indicates the desired sorting attribute (optional, default to timestamp)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function socialJobsGetRequest($limit = '100', $offset = null, $sort_by = 'timestamp', $sort_direction = 'DESC', $internal_id = null, $slug = null, $network = null, $resource = null, $content = null)
    {

        $resourcePath = '/social/jobs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
