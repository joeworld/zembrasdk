...
/**
 * SocialMediaDetailsApi Class Doc Comment
 *
 * @category Class
 * @package  Zembra\Client
 * @author   Zembra Codegen team
...
class SocialMediaDetailsApi
{
    ...
    /**
     * Operation socialNetworkResourceSlugGet
     *
     ...
     * @return \Zembra\Client\Model\InlineResponse20012
     */
    public function socialNetworkResourceSlugGet($network, $resource, $slug)
    {
        list($response) = $this->socialNetworkResourceSlugGetWithHttpInfo($network, $resource, $slug);
        return $response;
    }

    /**
     * Operation socialNetworkResourceSlugGetWithHttpInfo
     *
     * Get details about a social media resource
     *
     * @param  \Zembra\Client\Model\SocialNetwork $network Target social network (required)
     ...
     * @throws \Zembra\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Zembra\Client\Model\InlineResponse20012, HTTP status code, HTTP response headers (array of strings)
     */
    public function socialNetworkResourceSlugGetWithHttpInfo($network, $resource, $slug)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20012';
        $request = $this->socialNetworkResourceSlugGetRequest($network, $resource, $slug);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse20012',
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Zembra\Client\Model\InlineResponse4045',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation socialNetworkResourceSlugGetAsync
     *
     * Get details about a social media resource
     *
     * @param  \Zembra\Client\Model\SocialNetwork $network Target social network (required)
     ...
     */
    public function socialNetworkResourceSlugGetAsync($network, $resource, $slug)
    {
        return $this->socialNetworkResourceSlugGetAsyncWithHttpInfo($network, $resource, $slug)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation socialNetworkResourceSlugGetAsyncWithHttpInfo
     *
     * Get details about a social media resource
     *
     * @param  \Zembra\Client\Model\SocialNetwork $network Target social network (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function socialNetworkResourceSlugGetAsyncWithHttpInfo($network, $resource, $slug)
    {
        $returnType = '\Zembra\Client\Model\InlineResponse20012';
        $request = $this->socialNetworkResourceSlugGetRequest($network, $resource, $slug);
    ...
    /**
     * Create request for operation 'socialNetworkResourceSlugGet'
     *
     * @param  \Zembra\Client\Model\SocialNetwork $network Target social network (required)
     * @param  \Zembra\Client\Model\Resource $resource Depending on the selected network, this will define what object you are trying to access details.    List of available resources varies by network:   - **Facebook**:   - page   - post - **Instagram**:   - hashtag   - post   - user - **LinkedIn**:   - company   - keyword   - profile   - post - **Reddit**:   - keyword   - post   - subreddit   - user - **TokTok**:   - hashtag   - user   - video (required)
     * @param  \Zembra\Client\Model\SocialSlug $slug Unique resource identifier. Full URLs are not accepted. Varies by network. Here are a few examples per resource:   - **Facebook**:   - Page: Presidence.tn   - Post: S:_I1391675561076747:3140064409571178 - **Instagram**:   - Hashtag: coupleprayer   - Post: CFzAp7DASJ0   - User: soumaya_belkouchi - **LinkedIn**:   - Company: zembra   - Keyword: san+diego   - Profile: bakayoko   - Post: urn:li:ugcPost:6971444261015724033 - **Reddit**:   - Keyword: sandiego   - Post: 12mizot   - Subreddit: Damnthatsinteresting   - User: coastalJuncture - **TokTok**:   - Hashtag: healthy   - User: justqueen1988   - Video: 7114961878434041094 (required)
     ...
     */
    protected function socialNetworkResourceSlugGetRequest($network, $resource, $slug)
    {
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling socialNetworkResourceSlugGet'
            );
        }
        // verify the required parameter 'resource' is set
        if ($resource === null || (is_array($resource) && count($resource) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $resource when calling socialNetworkResourceSlugGet'
            );
        }
        // verify the required parameter 'slug' is set
        if ($slug === null || (is_array($slug) && count($slug) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $slug when calling socialNetworkResourceSlugGet'
            );
        }

        $resourcePath = '/social/{network}/{resource}/{slug}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
