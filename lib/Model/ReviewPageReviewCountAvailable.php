<?php
/**
 * ReviewPageReviewCountAvailable
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ReviewPageReviewCountAvailable Class Doc Comment
 *
 * @category Class
 * @description Available reviews count breakdown.
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewPageReviewCountAvailable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewPage_reviewCount_available';
...
'hidden' => 'getHidden'    ];
     ...
     * Sets total
     *
     * @param int $total Number of reviews that the application was able to crawl and make available to the API.
     *
     * @return $this
     */
