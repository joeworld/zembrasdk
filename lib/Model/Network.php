 ...
 *
 * @category Class
 * @description Short name of the network. Used in the queries
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
const GOOGLE = 'google';
const INDEED = 'indeed';
const OPENTABLE = 'opentable';
const ORBITZ = 'orbitz';
const PAGESJAUNES = 'pagesjaunes';
const TRAVELOCITY = 'travelocity';
const TREATWELL = 'treatwell';
