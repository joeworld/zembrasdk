...
/**
 * BatchBreakdown Class Doc Comment
 *
 * @category Class
 * @description A breakdown of the requests per status. Under each status, you will get the count of requests and the list of request indexes starting from 1 to a maximum of 1,000.
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BatchBreakdown implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Batch_breakdown';
    ...
    protected static $swaggerTypes = [
        'scheduled' => '\Zembra\Client\Model\BatchBreakdownScheduled',
'progress' => '\Zembra\Client\Model\BatchBreakdownProgress',
'success' => '\Zembra\Client\Model\BatchBreakdownSuccess',
'failed' => '\Zembra\Client\Model\BatchBreakdownFailed',
'canceled' => '\Zembra\Client\Model\BatchBreakdownCanceled'    ];
...
'canceled' => 'getCanceled'    ];
     ...
     * Gets scheduled
     *
     * @return \Zembra\Client\Model\BatchBreakdownScheduled
     */
     ...
     * Sets scheduled
     *
     * @param \Zembra\Client\Model\BatchBreakdownScheduled $scheduled scheduled
     *
     * @return $this
     */
     ...
     * Gets progress
     *
     * @return \Zembra\Client\Model\BatchBreakdownProgress
     */
     ...
     * Sets progress
     *
     * @param \Zembra\Client\Model\BatchBreakdownProgress $progress progress
     *
     * @return $this
     */
     ...
     * Gets success
     *
     * @return \Zembra\Client\Model\BatchBreakdownSuccess
     */
     ...
     * Sets success
     *
     * @param \Zembra\Client\Model\BatchBreakdownSuccess $success success
     *
     * @return $this
     */
     ...
     * Gets failed
     *
     * @return \Zembra\Client\Model\BatchBreakdownFailed
     */
     ...
     * Sets failed
     *
     * @param \Zembra\Client\Model\BatchBreakdownFailed $failed failed
     *
     * @return $this
     */
     ...
     * Gets canceled
     *
     * @return \Zembra\Client\Model\BatchBreakdownCanceled
     */
     ...
     * Sets canceled
     *
     * @param \Zembra\Client\Model\BatchBreakdownCanceled $canceled canceled
     *
     * @return $this
     */
