...
/**
 * SlugContentBody1 Class Doc Comment
 *
 * @category Class
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SlugContentBody1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'slug_content_body_1';
...
'stream_date_limit' => 'getStreamDateLimit'    ];
     ...
     * Sets internal_id
     *
     * @param string $internal_id This is your application's internal ID. It can help you identify the requested resource, particularly when you activate listeners and we send you a change notification.
     *
     * @return $this
     */
     ...
     *
     * @param int $stream_size_limit Instructs the API to only collect up to this number of elements. For example, an Instagram post may have thousands of comments but you are only interested in the first 500. This will make the pulling process abort at the 500th element.
     *
     * @return $this
     */
     ...
     *
     * @param int $stream_date_limit Instructs the API to only collect elements posted after and not older than this timestamp. For example, an Instagram post may have thousands of comments but you are only interested in those that were posted the last 24 hours. The pulling process will stop as soon as a collected comment is older than the given limit. All older comments are filtered out. The account is only charged for the eligible comments.
     *
     * @return $this
     */
