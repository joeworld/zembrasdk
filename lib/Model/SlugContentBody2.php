...
/**
 * SlugContentBody2 Class Doc Comment
 *
 * @category Class
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SlugContentBody2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'slug_content_body_2';
     ...
     * Sets internal_id
     *
     * @param string $internal_id Please see the description for `internalId` on **[GET] /social/{network}/{resource}/{slug}**
     *
     * @return $this
     */
