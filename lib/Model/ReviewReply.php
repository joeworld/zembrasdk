...
/**
 * ReviewReply Class Doc Comment
 *
 * @category Class
 * @description Details about the review reply from the business owner
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewReply';
...
'author' => 'getAuthor'    ];
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp Date and time the response was posted on the native site
     *
     * @return $this
     */
