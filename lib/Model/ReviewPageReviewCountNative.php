...
/**
 * ReviewPageReviewCountNative Class Doc Comment
 *
 * @category Class
 * @description Reviews count breakdown as it appears on the native site.
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewPageReviewCountNative implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewPage_reviewCount_native';
...
'hidden' => 'getHidden'    ];
     ...
     * Sets total
     *
     * @param int $total Total review count as it appears on the native site. Does not include edits and deleted reviews. It is also the sum of active and hidden reviews.
     *
     * @return $this
     */
     ...
     * Sets active
     *
     * @param int $active This is the number of visible reviews or sometimes called recommended reviews.
     *
     * @return $this
     */
     ...
     * Sets hidden
     *
     * @param int $hidden Some networks might display or treat reviews as not-recommended and exclude them from the reviews count aggregate.
     *
     * @return $this
     */
