...
/**
 * SocialSlug Class Doc Comment
 *
 * @category Class
 * @description Unique resource identifier. Full URLs are not accepted. Varies by network. Here are a few examples per resource:       - **Facebook**:       - Page: Presidence.tn       - Post: S:_I1391675561076747:3140064409571178     - **Instagram**:       - Hashtag: coupleprayer       - Post: CFzAp7DASJ0       - User: soumaya_belkouchi     - **LinkedIn**:       - Company: zembra       - Profile: bakayoko       - Post: urn:li:ugcPost:6971444261015724033     - **TokTok**:       - Hashtag: healthy       - User: justqueen1988       - Video: 7114961878434041094
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialSlug implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialSlug';
