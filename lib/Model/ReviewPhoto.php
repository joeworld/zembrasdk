...
/**
 * ReviewPhoto Class Doc Comment
 *
 * @category Class
 * @description A photo that was uploaded as part of the review
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewPhoto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReviewPhoto';
