...
/**
 * Slug Class Doc Comment
 *
 * @category Class
 * @description Unique business identifier per network
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Slug implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Slug';
