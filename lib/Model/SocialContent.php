...
/**
 * SocialContent Class Doc Comment
 *
 * @category Class
 * @package  Zembra\Client
 * @author   Zembra Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialContent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialContent';
...
'url' => 'getUrl'    ];
     ...
     * Sets id
     *
     * @param string $id Content identifier as it appears on the native site. For some networks it is the same as the slug.
     *
     * @return $this
     */
